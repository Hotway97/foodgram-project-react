...
```bash
git clone https://github.com/Hotway97/foodgram-project-react.git
...
[http://62.84.124.5](http://62.84.124.5)

* Логин администратора hotway97
* Пароль vfrc48156

## Документация к API
API документация доступна по ссылке (создана с помощью redoc):
[http://62.84.124.5/api/docs/](http://62.84.124.5/api/docs/)

## Авторы: 
[Алексеев Илья](https://github.com/hotway97) - Python разработчик. Разработал бэкенд и деплой для сервиса Foodgram. 
